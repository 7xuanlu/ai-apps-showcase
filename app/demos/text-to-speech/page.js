...
const languageOptions = [
  ...
  },
  {
    ...
    styles: ["neutral", "newscast", "customerservice", "assistant", "lyrical"],
  },
  {
    value: "ja-JP",
    label: "Japanese - JP",
    voices: ["ja-JP-Ayumi-Apollo"],
    styles: ["neutral"],
  },
  {
    value: "ko-KR",
    label: "Korean - KR",
    voices: ["ko-KR-HeamiRUS"],
    styles: ["neutral"],
  },
  {
    value: "es-ES",
    label: "Spanish - ES",
    voices: ["es-ES-Laura-Apollo"],
    styles: ["neutral"],
  },
  {
    value: "fr-FR",
    label: "French - FR",
    voices: ["fr-FR-Julie-Apollo"],
    styles: ["neutral"],
  },
];
  ...
  return (
    <div className="w-full max-w-4xl mx-auto mt-12 bg-white rounded-lg">
      ...
      <FeatureGuard>
        ...
        <div>
          <label htmlFor="voice" className="block mb-2 font-medium">
            Voice
          </label>
          <select
            id="voice"
        ...
        <div>
          <label htmlFor="speakingStyle" className="block mb-2 font-medium">
            Speaking styles
          </label>
          <select
            id="speakingStyle"
